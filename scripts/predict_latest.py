...
def find_latest_model(experiments_dir: Path = None) -> Path:
    ...
    if not experiments_dir.exists():
        raise FileNotFoundError(f"Diretório de experimentos não encontrado: {experiments_dir}")
    ...
    logger.info(f"📦 Modelo mais recente encontrado: {latest_model.parent.parent.name}")
